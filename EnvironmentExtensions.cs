...
public static class CoStarEnvironments
{
    public const string Development = "DEV";
    public const string CoStarTesting = "TST";
    public const string CoStarOps = "TSM";
    public const string CoStarStaging = "TSR";
    public const string CoStarProd = "PRD";
}
