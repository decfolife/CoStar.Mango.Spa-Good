...
import { preventChangeLossGuardFn } from '@mango/core-shared';
...
const routes: Routes = [
  { path: '', redirectTo: 'render-form', pathMatch: 'full' },
  {
    ...
    canActivate: [DynamicFormClearStateGuard],
    canDeactivate: [preventChangeLossGuardFn],
    data: { breadCrumb: { label: ' ', append: true, activeLink: ' ' } },
  },
  {
    path: 'admin-forms',
    component: AdminRenderFormComponent,
    data: {
      moduleId: 6,
      breadCrumb: { label: 'Forms Maintenance', append: true },
    },
    children: [
      { path: '', redirectTo: 'list', pathMatch: 'full' },
      {
        path: 'list',
        component: DynamicFormsListComponent,
        canActivate: [DynamicFormClearStateGuard],
        data: { moduleId: 6 },
      },
      {
