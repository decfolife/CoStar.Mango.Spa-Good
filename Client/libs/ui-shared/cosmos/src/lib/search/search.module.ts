...
export class SearchModule {
  constructor(private registry: MatIconRegistry, private sanitizer: DomSanitizer){
   this.registry.addSvgIconLiteral('brandsearch', this.sanitizer.bypassSecurityTrustHtml(brandsearch));
   this.registry.addSvgIconLiteral('brandclose', this.sanitizer.bypassSecurityTrustHtml(brandclose));
  }
}
