...
export class DataService extends EndpointService {
  ...
  getPortfolioMetricDataByElementType(
  ...
  getProjectMetricDataByElementType(
    elementTypeName: string,
    selectedFilters: string
  ): Observable<any> {
    return of(1);
  ...
  fetchAllPortfolioMetrics(
    ...
    return this.callHttpPost(url, 'getAllPortfolioMetrics', {
      schemaMetrics,
      unitOfMeasureId,
      selectedFilters,
      exchangeRateId,
  ...
  fetchAllProjectMetrics(
    ...
    return this.callHttpPost(url, 'getAllProjectMetrics', {
      schemaMetrics,
      selectedFilters,
    });
  }
