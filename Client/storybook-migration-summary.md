...
- `npx storybook@latest automigrate --config-dir libs/ui-shared/lib-ui-elements/.storybook --renderer @storybook/angular`

- `npx storybook@latest automigrate --config-dir libs/ui-shared/lib-ui-shared/.storybook --renderer @storybook/angular`

- `npx storybook@latest automigrate --config-dir libs/ui-shared/storybook-host/.storybook --renderer @storybook/angular`
