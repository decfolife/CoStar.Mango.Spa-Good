...
export const error = createSelector(getAppState, (state: State) => state.error);

export const user = createSelector(getAppState, (state: State) => state.user);
...
export const isUserAuthenticated = createSelector(
  getAppState,
  (state: State) =>
    !!state.user && !!state.selectedClient && !!state.selectedContactId
);
