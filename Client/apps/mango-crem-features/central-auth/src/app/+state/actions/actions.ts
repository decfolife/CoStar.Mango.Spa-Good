import { ClientSSOSettings, ClientSitesByUser, ContactRecord, UserSite } from "@mango/data-models/lib-data-models";
...
export const setLoadCurrentUserComplete = createAction(LOAD_CURRENT_USER_COMPLETE, props<{ loadCurrentUserComplete: boolean }>());
...
export const setDefaultContactRecord = createAction(SET_DEFAULT_CONTACT_RECORD, props<{ defaultContact: DefaultContactRecordSelection }>());
