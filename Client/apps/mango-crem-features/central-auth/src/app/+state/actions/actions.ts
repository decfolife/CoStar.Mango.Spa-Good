...
export const REDIRECT_TO_CUSTOMER_SELECTION =
  '[UI] Redirect To Customer Selection';
export const HANDLE_USER_ALREADY_LOGGED_IN =
  '[UI] Handle User Already Logged IN';
export const HANDLE_SSO_CLIENT_LOGIN = '[UI] Handle SSO Client Login';
export const LOAD_CURRENT_USER = '[UI] Load Logged-In User';
...
export const START_AUTHORIZATION_WHEN_FULLY_SELECTED =
  '[UI] Go To Authorization When Fully Selected';
...
export const LOAD_CURRENT_USER_COMPLETE = '[UI] Load Logged-In User Completed';
...
export const GET_CLIENT_SSO_SETTINGS_SUCCESS =
  '[UI] Get Client SSO Settings Success';
...
export const LOG_OUT_WHEN_CLIENT_SPECIFIC_LOGIN_AND_LOGIN_TO_CLIENT_FAILED =
  '[UI] Log Out when client specific login and login to client failed';
...
export const setOpenClientInNewTab = createAction(
  SET_OPEN_CLIENT_IN_NEW_TAB,
  props<{ openClientInNewTab: boolean }>()
);
export const setIsSwitchContactRecord = createAction(
  SET_IS_SWITCH_CONTACT_RECORD,
  props<{ isSwitchContactRecord: boolean }>()
);
export const startAuthorizationWhenFullySelected = createAction(
  START_AUTHORIZATION_WHEN_FULLY_SELECTED
);
export const redirectToCustomerSelection = createAction(
  REDIRECT_TO_CUSTOMER_SELECTION
);
export const handleUserAlreadyLoggedIn = createAction(
  HANDLE_USER_ALREADY_LOGGED_IN
);
...
export const setupRouteAndQueryParams = createAction(
  SETUP_ROUTE_AND_QUERY_PARAMS
);
...
export const setupLogoutWhenTimedOut = createAction(
  SETUP_LOGOUT_WHEN_TIMED_OUT
);
export const setupLogoutEventListener = createAction(
  SETUP_LOGOUT_EVENT_LISTENER
);
export const logoutWhenIsClientSpecificLoginAndloginToClientSiteFailed =
  createAction(LOG_OUT_WHEN_CLIENT_SPECIFIC_LOGIN_AND_LOGIN_TO_CLIENT_FAILED);
export const setLoadCurrentUserComplete = createAction(
  LOAD_CURRENT_USER_COMPLETE,
  props<{ loadCurrentUserComplete: boolean }>()
);
...
export const getUserClientsSuccess = createAction(
  ...
  props<{ clientSites: ClientSitesByUser }>()
);
export const getClientSSOSettings = createAction(
  GET_CLIENT_SSO_SETTINGS,
  props<{ clientKey: string }>()
);
export const getClientSSOSettingsSuccess = createAction(
  GET_CLIENT_SSO_SETTINGS_SUCCESS,
  props<{ ssoSettings: ClientSSOSettings }>()
);
export const getContactRecords = createAction(
  GET_CONTACT_RECORDS,
  props<{ clientKey: string }>()
);
export const getContactRecordsSuccess = createAction(
  GET_CONTACT_RECORDS_SUCCESS,
  props<{ contactRecords: ContactRecord[] }>()
);
export const setClientSpecificLogin = createAction(
  SET_IS_CLIENT_SPECIFIC_LOGIN,
  props<{ isClientSpecific: boolean }>()
);
export const setSelectedClient = createAction(
  SET_CLIENT,
  props<{ client: UserSite }>()
);
...
export const setDefaultContactRecord = createAction(
  SET_DEFAULT_CONTACT_RECORD,
  props<{ defaultContact: DefaultContactRecordSelection }>()
);
export const setRedirectionUri = createAction(
  SET_REDIRECTION_URI,
  props<{ redirectionUri: string }>()
);
