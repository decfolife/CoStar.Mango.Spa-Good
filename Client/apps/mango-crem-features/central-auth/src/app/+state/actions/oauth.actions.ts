...
export const SETUP_OAUTH_REDIRECTION_TO_CLIENT =
  '[UI] Setup Redirection To Client When Logged In';
...
export const setupOAuthRedirectionToClient = createAction(
  SETUP_OAUTH_REDIRECTION_TO_CLIENT
);
