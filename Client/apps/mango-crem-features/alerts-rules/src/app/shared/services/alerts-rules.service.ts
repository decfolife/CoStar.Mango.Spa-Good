...
export class AlertsRulesService extends EndpointService {
  ...
  getUserModuleRights() {
    return this.callHttpGet(
      `${this.alertsUrl}alerts/GetUserModuleRights`,
      'getUserModuleRights'
    );
  }
  ...
  getAlertTypes() {
    return this.callHttpGet(
      `${this.alertsUrl}alerts/GetAlertTypes`,
      'getAlertTypes'
    );
  }
  ...
  getAlertRuleSeverities() {
    return this.callHttpGet(
      `${this.alertsUrl}alerts/GetAlertRuleSeverities`,
      'getAlertRuleSeverities'
    );
  }
  ...
  getAlertRules(OTID: number) {
    return this.callHttpGet(
      `${this.alertsUrl}alerts/GetAlertRules/${OTID}`,
      'getAlertRules'
    );
  }
  ...
  updateAlertRules(rules: AlertRuleUpdate[]) {
    return this.callHttpPost(
      `${this.alertsUrl}alerts/UpdateAlertRules`,
      'updateAlertRules',
