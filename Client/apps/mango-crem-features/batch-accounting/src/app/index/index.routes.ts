...
export const ROUTES = [
  {
    ...
    data: {
      breadCrumb: {
        label: 'Batch Accounting',
        append: true,
        activeLink: 'Batch Accounting',
      },
    },
  },
  {
    ...
    data: {
      breadCrumb: {
        label: 'Batch Logs',
        append: true,
        activeLink: 'Batch Logs',
      },
    },
  }, // todo: remove once fully moved to MangoSpa, redundant
  {
    path: 'batcheventlist',
    component: BatchEventListComponent,
    data: {
      breadCrumb: {
        label: 'Batch Event List',
        append: true,
        activeLink: 'Batch Event List',
      },
    },
  },
];
