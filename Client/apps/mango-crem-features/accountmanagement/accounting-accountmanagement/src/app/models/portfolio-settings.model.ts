export class PortfolioSettings {
  ...
  constructor(
    masterGroupID,
    leaseRecognitionCalendarID,
    amortizationMethodType,
    defaultPaymentTimingType,
    journalEntryProfileRequired,
    defaultCompoundFrequencyType,
    functionalCurrencyEnabled,
    discountRateMatching,
    directEntryDiscountRateEnabled,
    defaultAnnualRateType,
    minMonthsOperator,
    maxMonthsOperator,
    functionalCurrencyRateset,
    functionalCurrencyPeriod,
    directEntryFunctionalCurrencyRateEnabled
  ) {
