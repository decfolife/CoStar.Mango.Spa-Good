...
export class AppModule implements DoBootstrap {
  ...
  public ngDoBootstrap(): void {
    customElements.get('ngce-crem-env-info-chip') ||
      customElements.define(
        'ngce-crem-env-info-chip',
        createCustomElement(CremEnvInfoChipAppComponent, {
          injector: this.injector,
        })
      );

    customElements.get('ngce-module-left-nav') ||
      customElements.define(
        'ngce-module-left-nav',
        createCustomElement(ModuleLeftNavAppComponent, {
          injector: this.injector,
        })
      );

    customElements.get('ngce-bookmarks') ||
      customElements.define(
        'ngce-bookmarks',
        createCustomElement(BookmarksAppComponent, { injector: this.injector })
      );

    customElements.get('ngce-alert-chip') ||
      customElements.define(
        'ngce-alert-chip',
        createCustomElement(AlertChipComponent, { injector: this.injector })
      );

    customElements.get('ngce-emulate-user') ||
      customElements.define(
        'ngce-emulate-user',
        createCustomElement(EmulateUserAppComponent, {
          injector: this.injector,
        })
      );

    customElements.get('ngce-lease-alerts-popup') ||
      customElements.define(
        'ngce-lease-alerts-popup',
        createCustomElement(LeaseAlertsComponent, { injector: this.injector })
      );

    customElements.get('ngce-add-form-wizard') ||
      customElements.define(
        'ngce-add-form-wizard',
        createCustomElement(OpenFormWizardModalComponent, {
          injector: this.injector,
        })
      );

    customElements.get('ngce-object-actions-popup') ||
      customElements.define(
        'ngce-object-actions-popup',
        createCustomElement(ObjectActionsComponent, { injector: this.injector })
      );

    customElements.get('ngce-widget-history-popup') ||
      customElements.define(
        'ngce-widget-history-popup',
        createCustomElement(OpenWidgetHistoryModalComponent, {
          injector: this.injector,
        })
      );
  }
