import { AdminFlags, BreadCrumb, Client, ContactRecord, GlobalSessionHttpObject, MangoSubApps, OAuthTokenHTTPResponse, RedirectorLink, UserAuth, UserInfo, V06GlobalSession } from '@mango/data-models/lib-data-models';
...
export const IS_EMULATING_USER = '[Mango App] Check If Currently Emulating a User'
export const SETUP_CLIENT_SETTINGS = '[Mango App] Set Client Settings For User'
export const SETUP_CLIENT_SETTINGS_SUCCESS = '[Mango App] Set Client Settings For User Success'
...
export const LOAD_REDIRECTOR_LINKS_SUCCESS = '[Mango App] Load Redirector Links Success'
...
export const setEmulatedUser = createAction(SET_EMULATED_USER, props<{ contactId: number, initiatedFromV06?: boolean }>());
export const stopEmulatingUser = createAction(STOP_EMULATING_USER, props<{ initiatedFromV06?: boolean }>());
