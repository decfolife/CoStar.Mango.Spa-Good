...
@Component({
	selector: 'my-deals-list',
	templateUrl: './my-deals-list.component.html',
	styleUrls: ['./my-deals-list.component.scss'],
	providers: [Service]
})
export class MyDealsListComponent implements OnInit {
