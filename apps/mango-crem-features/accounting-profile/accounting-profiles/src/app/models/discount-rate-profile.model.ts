...
export class DiscountRateProfile {
	...
	constructor(policyId, masterGroupId, amount, profileAlias, termRangeMinMonths,
	  termRangeMaxMonths, effectiveDate, effectiveDateString, country, currency, annualRateType, portfolio,
	  profileName, sourceImportId, modifiedByName, createdByName, active, inUse,
	  accountingSchedules, createdByDate, lastModifiedDate, createdBy, lastModifiedBy,
