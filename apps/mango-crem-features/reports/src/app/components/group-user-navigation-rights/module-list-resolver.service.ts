...
export class ModuleListResolver implements Resolve<ResolvedData> {

    constructor(private groupUserNavigationRightsService: GroupUserNavigationRightsService) { }

    resolve(route: ActivatedRouteSnapshot,
        state: RouterStateSnapshot): Observable<ResolvedData> {
        return this.groupUserNavigationRightsService.getNavigationRightModuleList()
            .pipe(
