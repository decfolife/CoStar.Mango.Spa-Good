...
import { CardModule, DropdownModule, SimpleGridModule } from '@mango/ui-shared/lib-ui-elements';
...
describe('DashboardCardComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      ...
      imports: [DropdownModule, CardModule, SimpleGridModule, DxLoadPanelModule, CremPivotTableModule, MatIconModule, MatMenuModule],
  ...
  @Component({
    ...
    template: '<mango-accounting-card [config]="config"></mango-accounting-card>'
})
class HostComponent {
    private config = {
        allowDrillDown: true,
